...
const totalContributions = GAMES_JSON.reduce((total, backers) => { 
...
const gamesCardAmount = GAMES_JSON.reduce((total, game) => {
    return total + 1;
},0 );

gamesCard.innerHTML = `${gamesCardAmount.toLocaleString('en-US')}`;
/*************************************************************************************
